 ...
 * @author rmorales1
 */
public class CantidadTrabajadores extends javax.swing.JDialog {

    /**
     * Creates new form Agregar
     */
    String rutaT;
    public CantidadTrabajadores(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel1.setText("CANTIDAD DE TRABAJADORES INGRESADOS");
        jPanel1.add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 15, -1, -1));
        ...
        setSize(new java.awt.Dimension(397, 343));
    ...
    private void cmdOkActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cmdOkActionPerformed
        ...
        if (chkM.isSelected() && chkF.isSelected() && chkI.isSelected()) {
            cant = Helper.cantidadTrabajadores(rutaT, "Masculino", "Femenino", "Indefinido");
            Helper.mensaje(this, cant, 1);
        }
        else if (chkM.isSelected() && chkF.isSelected()) {
            cant = Helper.cantidadTrabajadores(rutaT, "Masculino", "Femenino");
            Helper.mensaje(this, cant, 1);
        }
        else if (chkM.isSelected() && chkI.isSelected()) {
            cant = Helper.cantidadTrabajadores(rutaT, "Masculino", "Indefinido");
            Helper.mensaje(this, cant, 1);
        }
        else if (chkF.isSelected() && chkI.isSelected()) {
            cant = Helper.cantidadTrabajadores(rutaT, "Femenino", "Indefinido");
            Helper.mensaje(this, cant, 1);
        }
        else if (chkM.isSelected()) {
            cant = Helper.cantidadTrabajadores(rutaT, "Masculino");
            Helper.mensaje(this, cant, 1);
        }
        else if (chkF.isSelected()) {
            cant = Helper.cantidadTrabajadores(rutaT, "Femenino");
            Helper.mensaje(this, cant, 1);
        }
        else if (chkI.isSelected()){
            cant = Helper.cantidadTrabajadores(rutaT, "Indefinido");
            Helper.mensaje(this, cant, 1);
        }
        else if (chkTotal.isSelected()) {
            int cont;
            cont = Helper.traerDatos(rutaT).size();
            Helper.mensaje(this, "Hay "+cont + " trabajadores ingresados.", 1);
        }
        else {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(CantidadTrabajadores.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                CantidadTrabajadores dialog = new CantidadTrabajadores(new javax.swing.JFrame(), true);
