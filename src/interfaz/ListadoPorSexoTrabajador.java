 ...
 * @author rmorales1
 */
public class ListadoPorSexoTrabajador extends javax.swing.JDialog {

    /**
     * Creates new form Agregar
     */
    String rutaT;
    public ListadoPorSexoTrabajador(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        jPanel5.add(jScrollPane2, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 20, 640, 230));

        jPanel1.add(jPanel5, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 130, 660, 260));
        ...
        jPanel1.add(cmbSexo, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 70, 180, 30));
    ...
    private void cmbSexoItemStateChanged(java.awt.event.ItemEvent evt) {//GEN-FIRST:event_cmbSexoItemStateChanged
        ...
        Helper.listadoPorSexoTrabajador(tblTrabajadores, rutaT, sexo);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ListadoPorSexoTrabajador.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                ListadoPorSexoTrabajador dialog = new ListadoPorSexoTrabajador(new javax.swing.JFrame(), true);
